...
description: Create or update `.chadwin-data/user_preferences.json` through an interactive conversation that captures market coverage, sector/industry preferences, strategy preferences, and report-content preferences.
---
...
1. Read `.chadwin-data/user_preferences.json` if it exists; otherwise start from the output contract schema.
...
11. Persist the updated JSON in `.chadwin-data/user_preferences.json`.
