...
Write one JSONL file per business day per form to `assets/<FORM>/YYYY-MM-DD.jsonl`.
...
- `--output-root` (optional): output directory; defaults to this skill's `assets/`
- If no date argument is provided, default mode is `latest-complete`.

## Output Layout
- `.agents/skills/fetch-daily-sec-filings/assets/10-K/YYYY-MM-DD.jsonl`
- `.agents/skills/fetch-daily-sec-filings/assets/10-Q/YYYY-MM-DD.jsonl`
- `.agents/skills/fetch-daily-sec-filings/assets/20-F/YYYY-MM-DD.jsonl`
- `.agents/skills/fetch-daily-sec-filings/assets/8-K/YYYY-MM-DD.jsonl`
- `.agents/skills/fetch-daily-sec-filings/assets/6-K/YYYY-MM-DD.jsonl`
- `.agents/skills/fetch-daily-sec-filings/assets/S-1/YYYY-MM-DD.jsonl`
