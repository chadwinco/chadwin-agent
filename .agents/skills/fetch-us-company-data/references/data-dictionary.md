...
- Bootstrap valuation output: `<DATA_ROOT>/companies/US/<TICKER>/reports/<YYYY-MM-DD>/valuation/inputs.yaml`
...
- `<DATA_ROOT>/companies/US/<TICKER>/data/financial_statements/annual/`
- `<DATA_ROOT>/companies/US/<TICKER>/data/financial_statements/quarterly/`
