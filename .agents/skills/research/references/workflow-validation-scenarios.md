...
- `python chadwin-codex/.agents/skills/fetch-us-investment-ideas/scripts/fetch_us_investment_ideas.py --limit 5 --output chadwin-codex/idea-screens/<YYYY-MM-DD>/ideas.json`
