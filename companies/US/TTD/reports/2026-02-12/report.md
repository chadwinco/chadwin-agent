# The Trade Desk, Inc. (TTD) Deep-Dive Revision

_As of 2026-02-12 (Baseline package: 2026-02-08)_

## Executive Delta
- Prior verdict: Attractive
- Revised verdict: Watch
- Prior base value: $33.48/share
- Revised base value: $24.96/share
- Prior current price: $27.04
- Revised current price input: $27.04
- Base MOS change: +23.8% to -7.7% (-31.5 pts)

- TTD still has strong client retention and a large net-cash cushion, but client spend is contractually non-committed and terminable on short notice, which weakens conviction in sustaining baseline growth assumptions.
- Deep-dive cost-quality checks show recurring operating leverage risk: hosting/platform costs rose sharply in 2025 YTD and SBC remains materially high versus operating cash flow, pressuring normalized cash margins.
...
| --- | --- | --- | --- | --- |
| Growth durability in CTV/open internet | TTD can sustain ~10% stage-1 growth with limited cyclicality | MSAs are terminable with limited spend commitments; historical and peer evidence indicates ad budgets are macro-sensitive | Weakened | Reduced base growth from 10.0% to 8.5% |
| Margin durability | FCF margins can hold near low-20s then fade to 18% | 2025 YTD platform ops/hosting expansion and persistent SBC intensity indicate lower normalized margin confidence | Weakened | Reduced base FCF margin from 23.0% to 21.5%; terminal from 18.0% to 16.5% |
| Identity/privacy resilience | Privacy changes are manageable without major valuation impact | Peer and industry disclosures continue to show targeting/measurement signal constraints and regulatory friction | Weakened | Added risk premium via higher discount rate and lower terminal growth |
...
| --- | --- | --- | --- | --- |
| Base | 8.5% stage-1 growth, 21.5% stage-1 FCF margin, 10.0% discount rate, 2.5% terminal growth, 16.5% terminal FCF margin | $24.96 | $33.48 | -$8.52 |
| Bull | 11.0% stage-1 growth, 24.5% stage-1 FCF margin, 9.3% discount rate, 3.0% terminal growth, 19.0% terminal FCF margin | $38.66 | $46.42 | -$7.76 |
| Bear | 4.5% stage-1 growth, 17.0% stage-1 FCF margin, 11.0% discount rate, 2.0% terminal growth, 13.5% terminal FCF margin | $14.01 | $17.78 | -$3.77 |
...
Disconfirming signal to track: no material signal-quality deterioration or monetization impact disclosed over the next 2-3 quarters across TTD and major ad platforms.
2. CTV and broader ad-budget cyclicality remains open.
Disconfirming signal to track: sustained double-digit TTD revenue growth despite weaker macro conditions without margin degradation.
3. Margin compression risk from hosting/SBC remains open.
Disconfirming signal to track: platform-operations growth moderates to at or below revenue growth and SBC burden trends down as a share of OCF.
4. Governance execution risk from finance leadership transition remains open.
Disconfirming signal to track: stable CFO succession outcome and clean control/governance disclosures in upcoming filings.
